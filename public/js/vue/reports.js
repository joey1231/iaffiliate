...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.http.headers.common['X-CSRF-TOKEN'] = window.Laravel.csrfToken;
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  ...
  methods: {
    ...
    showBanStatus: function showBanStatus(status) {
      var label = '';
      if (status == 0) {
        label = 'Not Ban';
      }
